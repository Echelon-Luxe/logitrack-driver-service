...
Owns driversdb. Driver profiles and availability. Consumes shipment.assigned / shipment.delivered.
...
```bash
npm ci
npm run dev        # tsx watch, listens on 3003
...
`ghcr.io/echelon-luxe/logitrack-driver-service:<git-sha>`.
